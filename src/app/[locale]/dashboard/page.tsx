    ...
    <div className="p-6 lg:p-8 max-w-7xl">
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <Link href={`${prefix}/dashboard/schedule`} className="group rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:border-teal-200 hover:shadow-md transition-all">
          ...
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">{t("statToday")}</p>
        ...
        <Link href={`${prefix}/dashboard/patients`} className="group rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:border-blue-200 hover:shadow-md transition-all">
          ...
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">{t("statPatients")}</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2 mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-bold text-slate-900">{t("todaySchedule")}</h2>
            <Link href={`${prefix}/dashboard/schedule`} className="text-xs font-semibold text-teal-600 hover:text-teal-700">{t("viewAll")}</Link>
          </div>
          {todayAppts.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <p className="text-sm text-slate-400">{t("noApptsToday")}</p>
              <Link href={`${prefix}/dashboard/schedule`} className="mt-3 text-xs font-semibold text-teal-600 hover:underline">{t("scheduleOne")}</Link>
            </div>
          ) : (
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-bold text-slate-900">{t("next7Days")}</h2>
            <Link href={`${prefix}/dashboard/schedule`} className="text-xs font-semibold text-teal-600 hover:text-teal-700">{t("viewAll")}</Link>
          </div>
